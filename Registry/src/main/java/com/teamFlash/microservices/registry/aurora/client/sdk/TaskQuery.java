            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                {
                  _elem154 = com.teamFlash.microservices.registry.aurora.client.sdk.ScheduleStatus.findByValue(iprot.readI32());
      ...
      if (incoming.get(4)) {
        {
          ...
          {
            _elem179 = com.teamFlash.microservices.registry.aurora.client.sdk.ScheduleStatus.findByValue(iprot.readI32());
